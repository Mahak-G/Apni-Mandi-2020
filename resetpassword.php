...
$new_password = $confirm_password = $USERID="";
$new_password_err = $confirm_password_err =$USERID_err= "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if(empty(trim($_POST["USERID"]))){
		...
		if(mysqli_stmt_execute($stmt))
		{
			...
			{
				  $USERID_err = "This USERID does not exists.";
	       		}
			else
			{
    ...
    if(empty($new_password_err) && empty($confirm_password_err)){
        $sql = "UPDATE `USERS` SET `PSWD`=? WHERE `USERID` = ?";
...
<html>
<head>
<title>Emandi/resetpassword</title>
<!-- for-mobile-apps -->
				...
				<div class="module form-module">
				  <div class="toggle"><i class="fa fa-times fa-pencil"></i>
				   ...
				   <div class="form">
					...
					<form method="post"> 
					<input type="text" name="USERID" placeholder="user id" required=" "><span><?php echo $USERID_err; ?></span>
					  <input type="password" name="new_password" placeholder="New Password" required=" "><span><?php echo $new_password_err; ?></span>
					 <input type="password" name="confirm_password" placeholder="Confirm Password" required=" "><span><?php echo $confirm_password_err; ?></span>
					  <input type="submit" value="Reset">
					<div class="cta"> 
					<ins><a href="login.php">Cancel</a></ins>
				  </div>
					</form>
				  </div>
			</div>
