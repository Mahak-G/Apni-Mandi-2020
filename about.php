...
<!-- about -->
		<div class="privacy about">
			<h3>About Us</h3>
			<p class="animi">eKrishi is a pan-India electronic trading portal to create 
				a unified national market for agricultural commodities.
				<br>
				Agriculture is known as primary sector of country and contributes 
				only 17% GDP of country by providing 53% employment. In our portal, 
				there is a direct link between farmers and buyers for exchange of
				agricultural commodities.<br><br></p>

				<h2>VISION</h2>
			<p class="animi">To promote uniformity in agriculture marketing by 
				...
				<h2>OBJECTIVE</h2>
			<p class="animi">Assurance of stable prices for farmers and buyers with 
				quality assurance on a long term basis by removing auction system and 
				delaying increase of cost of produce.
				<br>
				Providing market at farmer’s doorstep giving ease to small scale markets.
				<br><br>
				</p>

				<h2>METHODOLY</h2>
			<p class="animi">Farmers need to sign-in the portal and need to update about 
				their production quantity as well as quality.
				<br>
				Buyers, too need to authenticate themselves and select farmer they want to buy from.
				Moreover, there are tips and suggestions section and Government policies section 
