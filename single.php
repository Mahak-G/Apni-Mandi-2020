...
<!-- banner -->
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			...
			<?php
				if(!empty($_COOKIE['prod']) && !empty($_COOKIE['set']) && ($_COOKIE['set']==true))
				{
 				$a=$_COOKIE['prod'];
				 $b=$_COOKIE['img'];
				 $c=$_COOKIE['qty'];
				...
				echo "<div class='col-md-4 agileinfo_single_left'>";
					echo "<img id='example' src='$b' alt=' ' class='img-responsive' />";
				echo "</div>";
				echo "<div class='col-md-8 agileinfo_single_right'>";
					...
					echo "<div class='w3agile_description'>";
						echo "<h4>Description:</h4>";
							echo "<p>Quantity: $c</p>";
							echo "<p>Quality: $d</p>";
							echo "<p>Harvest Time: $f</p>";
					echo "</div>";
					echo "<div class='snipcart-item block'>";
						echo "<div class='snipcart-thumb agileinfo_single_right_snipcart'>";
							echo "<h4>$e</h4>";
						echo "</div>";
						echo "<div class='snipcart-details agileinfo_single_right_details'>";
							echo "<form action='#' method='post'>";
								echo "<fieldset>";
									...
									echo "<input type='hidden' name='item_name' value='$a' />";
									echo "<input type='hidden' name='amount' value='$e' />";
									echo "<input type='hidden' name='discount_amount' value='0.00' />";
